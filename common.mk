CC=	  gcc
OBJS=	  main.o fifo.o ac.o input.o rb_tree.o usage.o array_goto.o rb_tree_goto.o options.o strquicksort.o
...
main.o ac.o fifo.o rb_tree.o array_goto.o rb_tree_goto.o options.o: $(INCLUDE_DIR)init.h
